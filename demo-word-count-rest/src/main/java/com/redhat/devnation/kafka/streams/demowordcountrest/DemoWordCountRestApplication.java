	...
	public RouteBuilder routeBuilder() {
		return new RouteBuilder() {
			...
			public void configure() throws Exception {
				...
				from("kafka:streams-wordcount-output?brokers={{camel.kafka.bootstrap.servers}}&valueDeserializer=org.apache.kafka.common.serialization.LongDeserializer&seekTo=beginning")
